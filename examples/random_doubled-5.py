...
#
target_folder='examples/random_doubled_5'

# input_path_single_section = make_random_path(seed=1, amplitude=3, make_ends_horizontal='both', end_with_zero=True)
input_path_single_section = make_random_path(seed=3, make_ends_horizontal=False, start_from_zero=True, end_with_zero=True, amplitude=3.5,

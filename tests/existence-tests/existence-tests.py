...
def test_trajectoid_existence(path_type='brownian', path_for_figs='examples/brownian_path_1/figures',
    ...
    if plot_solution:
        circle1 = plt.Circle((circle_center[0], circle_center[1]), 1/preliminary_best_scale, fill=False, linewidth=2, edgecolor='C1', alpha=circlealpha)
    ...
    solution_scale = preliminary_best_scale
    if plot_solution:
